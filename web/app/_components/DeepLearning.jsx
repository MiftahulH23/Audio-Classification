...
const DeepLearning = () => {
  return (
    <div className="grid grid-cols-4 place-items-center gap-5 bg-[#f2edff] px-6 py-10">
      {/* 1 */}
      ...
      {/* 2 */}
      <div className="flex h-80 w-[80%] flex-col items-center gap-2 rounded-xl bg-white px-4 py-8">
        <div className="p-2 flex h-10 w-10 items-center justify-center rounded-full bg-[#fde895]">
          <CNN lassName="h-full w-full" />
        </div>
        <p className="text-xl font-bold text-center">Convoluitonal Neural Network</p>
        <p className="text-center text-slate-400">
      ...
      <div className="flex h-80 w-[80%] flex-col items-center gap-2 rounded-xl bg-white px-4 py-8">
        ...
        <p className="text-xl font-bold text-center mt-2">Klasifikasi</p>
        <p className="text-center text-slate-400 mt-2">
        Klasifikasi dalam deep learning menggunakan jaringan saraf mendalam, seperti CNN atau RNN, untuk mengelompokkan data berdasarkan fitur kompleks
        </p>
      </div>
      {/* 4 */}
      <div className="flex h-80 w-[80%] flex-col items-center gap-5 rounded-xl bg-white px-4 py-8">
